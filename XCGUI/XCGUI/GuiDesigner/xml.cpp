...
std::map< std::string , std::vector<HELE> >					g_styleClassBind;
std::map< std::string , std::vector<HELE> >					g_styleAllBind;
...
HWINDOW XC_LoadXML_WindowX(TiXmlElement *pRoot,HXMLRES hXmlRes,HWND hWndParent)
{
	...
	}else if(0==strcmp(pWindow,"page"))
	{
		return XML_HandlePage(pRoot,hXmlRes,hWndParent);
	}
...
HWINDOW XML_HandlePage(TiXmlElement *pLabel,HXMLRES hXmlRes,HWND hWndParent)
{
	...
	TiXmlElement *pLabels = pLabel->FirstChildElement("picture");;
	GET_RECT(pLabels);
...
void SaveStyleBindEle( TiXmlElement *pLabel , HELE hEle )
{
	const char *styleClass=pLabel->Attribute("styleClass");
	if(styleClass) //套用样式
	{
		std::map< std::string , std::vector<HELE> >::iterator it = g_styleClassBind.find( styleClass );
		if( it != g_styleClassBind.end() )
		{
			std::vector<HELE> hEleList = it->second;
			hEleList.push_back( hEle );
			g_styleClassBind[ styleClass ] = hEleList;
		}
		else
		{
			std::vector<HELE> hEleList;
			hEleList.push_back( hEle );
			g_styleClassBind[ styleClass ] = hEleList;
		}
	}

	const char *styleAll=pLabel->Attribute("styleAll");
	if(styleAll) //套用样式
	{
		std::map< std::string , std::vector<HELE> >::iterator it = g_styleAllBind.find( styleClass );
		if( it != g_styleAllBind.end() )
		{
			std::vector<HELE> hEleList = it->second;
			hEleList.push_back( hEle );
			g_styleAllBind[ styleClass ] = hEleList;
		}
		else
		{
			std::vector<HELE> hEleList;
...
// 	}
	...
	if(pColor && strcmp(pColor , "#000000") != 0)
	{
		if(7==strlen(pColor)) //#ff00ff
		{
			wchar_t text[7]={0};
	...
	if(textColor && strcmp(textColor , "#000000") != 0)
	{
...
BOOL CSS_HandleEle(TiXmlElement *pLabel,HXMLRES hXmlRes,HWINDOW hWindow)
{
	...
	{
		const char *pName=pLabel->Attribute("name");
		if ( pName )
		{
			std::map< std::string , std::vector<HELE> >::iterator it = g_styleClassBind.find( pName );
			if( it != g_styleClassBind.end() )
			{
				std::vector<HELE> hEleList = it->second;
				for ( UINT i = 0 ; i < hEleList.size() ; i ++ )
				{
					CSS_HandleEle2(pLabel,hXmlRes,hWindow,hEleList[i]);
				}
				return true;
				//每个ele都来一次 ？
			}
	...
	}else if(0==strcmp(type,"all"))  //套用类型
	{
		const char *pName=pLabel->Attribute("name");
		if ( pName )
		{
			std::map< std::string , std::vector<HELE> >::iterator it = g_styleAllBind.find( pName );
			if( it != g_styleAllBind.end() )
			{
				std::vector<HELE> hEleList = it->second;
				for ( UINT i = 0 ; i < hEleList.size() ; i ++ )
	...
	if(0==strcmp(type,"class"))
	{
		...
		if ( pName )
		{
			...
			if( it != g_styleClassBind.end() )
			{
				...
				for ( UINT i = 0 ; i < hEleList.size() ; i ++ )
				{
					CSS_HandleButton2(pLabel,hXmlRes,hWindow,hEleList[i]);
				}
				return true;
				//每个ele都来一次 ？
			}
	...
	if(0==strcmp(type,"class"))
	{
		...
		if ( pName )
		{
			...
			if( it != g_styleClassBind.end() )
			{
				...
				for ( UINT i = 0 ; i < hEleList.size() ; i ++ )
				{
					CSS_HandleRadio2(pLabel,hXmlRes,hWindow,hEleList[i]);
				}
				return true;
				//每个ele都来一次 ？
			}
	...
	if(0==strcmp(type,"class"))
	{
		...
		if ( pName )
		{
			...
			if( it != g_styleClassBind.end() )
			{
				...
				for ( UINT i = 0 ; i < hEleList.size() ; i ++ )
				{
					CSS_HandleCheck2(pLabel,hXmlRes,hWindow,hEleList[i]);
				}
				return true;
				//每个ele都来一次 ？
			}
	...
	if(0==strcmp(type,"class"))
	{
		...
		if ( pName )
		{
			...
			if( it != g_styleClassBind.end() )
			{
				...
				for ( UINT i = 0 ; i < hEleList.size() ; i ++ )
				{
					CSS_HandleEdit2(pLabel,hXmlRes,hWindow,hEleList[i]);
				}
				return true;
				//每个ele都来一次 ？
			}
	...
	if(0==strcmp(type,"class"))
	{
		...
		if ( pName )
		{
			...
			if( it != g_styleClassBind.end() )
			{
				...
				for ( UINT i = 0 ; i < hEleList.size() ; i ++ )
				{
					CSS_HandleComboBox2(pLabel,hXmlRes,hWindow,hEleList[i]);
				}
				return true;
				//每个ele都来一次 ？
			}
	...
	if(0==strcmp(type,"class"))
	{
		...
		if ( pName )
		{
			...
			if( it != g_styleClassBind.end() )
			{
				...
				for ( UINT i = 0 ; i < hEleList.size() ; i ++ )
				{
					CSS_HandleScrollBar2(pLabel,hXmlRes,hWindow,hEleList[i]);
				}
				return true;
				//每个ele都来一次 ？
			}
	...
	if(0==strcmp(type,"class"))
	{
		...
		if ( pName )
		{
			...
			if( it != g_styleClassBind.end() )
			{
				...
				for ( UINT i = 0 ; i < hEleList.size() ; i ++ )
				{
					CSS_HandleScrollView2(pLabel,hXmlRes,hWindow,hEleList[i]);
				}
				return true;
				//每个ele都来一次 ？
			}
	...
	if(0==strcmp(type,"class"))
	{
		...
		if ( pName )
		{
			...
			if( it != g_styleClassBind.end() )
			{
				...
				for ( UINT i = 0 ; i < hEleList.size() ; i ++ )
				{
					CSS_HandleList2(pLabel,hXmlRes,hWindow,hEleList[i]);
				}
				return true;
				//每个ele都来一次 ？
			}
	...
	if(0==strcmp(type,"class"))
	{
		...
		if ( pName )
		{
			...
			if( it != g_styleClassBind.end() )
			{
				...
				for ( UINT i = 0 ; i < hEleList.size() ; i ++ )
				{
					CSS_HandleListBox2(pLabel,hXmlRes,hWindow,hEleList[i]);
				}
				return true;
				//每个ele都来一次 ？
			}
	...
	if(0==strcmp(type,"class"))
	{
		...
		if ( pName )
		{
			...
			if( it != g_styleClassBind.end() )
			{
				...
				for ( UINT i = 0 ; i < hEleList.size() ; i ++ )
				{
					CSS_HandleTree2(pLabel,hXmlRes,hWindow,hEleList[i]);
				}
				return true;
				//每个ele都来一次 ？
			}
	...
	if(0==strcmp(type,"class"))
	{
		...
		if ( pName )
		{
			...
			if( it != g_styleClassBind.end() )
			{
				...
				for ( UINT i = 0 ; i < hEleList.size() ; i ++ )
				{
					CSS_HandleMenuBar2(pLabel,hXmlRes,hWindow,hEleList[i]);
				}
				return true;
				//每个ele都来一次 ？
			}
	...
	if(0==strcmp(type,"class"))
	{
		...
		if ( pName )
		{
			...
			if( it != g_styleClassBind.end() )
			{
				...
				for ( UINT i = 0 ; i < hEleList.size() ; i ++ )
				{
					CSS_HandlePropertyPage2(pLabel,hXmlRes,hWindow,hEleList[i]);
				}
				return true;
				//每个ele都来一次 ？
			}
	...
	if(0==strcmp(type,"class"))
	{
		...
		if ( pName )
		{
			...
			if( it != g_styleClassBind.end() )
			{
				...
				for ( UINT i = 0 ; i < hEleList.size() ; i ++ )
				{
					CSS_HandleSliderBar2(pLabel,hXmlRes,hWindow,hEleList[i]);
				}
				return true;
				//每个ele都来一次 ？
			}
	...
	if(0==strcmp(type,"class"))
	{
		...
		if ( pName )
		{
			...
			if( it != g_styleClassBind.end() )
			{
				...
				for ( UINT i = 0 ; i < hEleList.size() ; i ++ )
				{
					CSS_HandleProgressBar2(pLabel,hXmlRes,hWindow,hEleList[i]);
				}
				return true;
				//每个ele都来一次 ？
			}
	...
	if(0==strcmp(type,"class"))
	{
		...
		if ( pName )
		{
			...
			if( it != g_styleClassBind.end() )
			{
				...
				for ( UINT i = 0 ; i < hEleList.size() ; i ++ )
				{
					CSS_HandleToolBar2(pLabel,hXmlRes,hWindow,hEleList[i]);
				}
				return true;
				//每个ele都来一次 ？
			}
	...
	if(0==strcmp(type,"class"))
	{
		...
		if ( pName )
		{
			...
			if( it != g_styleClassBind.end() )
			{
				...
				for ( UINT i = 0 ; i < hEleList.size() ; i ++ )
				{
					CSS_HandleStatic2(pLabel,hXmlRes,hWindow,hEleList[i]);
				}
				return true;
				//每个ele都来一次 ？
			}
	...
	if(0==strcmp(type,"class"))
	{
		...
		if ( pName )
		{
			...
			if( it != g_styleClassBind.end() )
			{
				...
				for ( UINT i = 0 ; i < hEleList.size() ; i ++ )
				{
					CSS_HandleGroupBox2(pLabel,hXmlRes,hWindow,hEleList[i]);
				}
				return true;
				//每个ele都来一次 ？
			}
	...
	if(0==strcmp(type,"class"))
	{
		...
		if ( pName )
		{
			...
			if( it != g_styleClassBind.end() )
			{
				...
				for ( UINT i = 0 ; i < hEleList.size() ; i ++ )
				{
					CSS_HandlePicture2(pLabel,hXmlRes,hWindow,hEleList[i]);
				}
				return true;
				//每个ele都来一次 ？
			}
	...
	if(0==strcmp(type,"class"))
	{
		...
		if ( pName )
		{
			...
			if( it != g_styleClassBind.end() )
			{
				...
				for ( UINT i = 0 ; i < hEleList.size() ; i ++ )
				{
					CSS_HandleMonthCal2(pLabel,hXmlRes,hWindow,hEleList[i]);
				}
				return true;
				//每个ele都来一次 ？
			}
	...
	if(0==strcmp(type,"class"))
	{
		...
		if ( pName )
		{
			...
			if( it != g_styleClassBind.end() )
			{
				...
				for ( UINT i = 0 ; i < hEleList.size() ; i ++ )
				{
					CSS_HandleDateTime2(pLabel,hXmlRes,hWindow,hEleList[i]);
				}
				return true;
				//每个ele都来一次 ？
			}
	...
	if(0==strcmp(type,"class"))
	{
		...
		if ( pName )
		{
			...
			if( it != g_styleClassBind.end() )
			{
				...
				for ( UINT i = 0 ; i < hEleList.size() ; i ++ )
				{
					CSS_HandlePGrid2(pLabel,hXmlRes,hWindow,hEleList[i]);
				}
				return true;
				//每个ele都来一次 ？
			}
	...
	if(0==strcmp(type,"class"))
	{
		...
		if ( pName )
		{
			...
			if( it != g_styleClassBind.end() )
			{
				...
				for ( UINT i = 0 ; i < hEleList.size() ; i ++ )
				{
					CSS_HandleChooseColor2(pLabel,hXmlRes,hWindow,hEleList[i]);
				}
				return true;
				//每个ele都来一次 ？
			}
	...
	if(0==strcmp(type,"class"))
	{
		...
		if ( pName )
		{
			...
			if( it != g_styleClassBind.end() )
			{
				...
				for ( UINT i = 0 ; i < hEleList.size() ; i ++ )
				{
					CSS_HandlePropertyPageLabel2(pLabel,hXmlRes,hWindow,hEleList[i]);
				}
				return true;
				//每个ele都来一次 ？
			}
...
BOOL CSS_HandleButton2(TiXmlElement *pLabel,HXMLRES hXmlRes,HWINDOW hWindow,HELE hEle)
{
	...
	if(image_leave && strlen(image_leave) != 0)
	{
	...
	if(image_stay && strlen(image_stay) != 0)
	{
	...
	if(image_down && strlen(image_down) != 0)
	{
	...
	if(image_check && strlen(image_check) != 0)
	{
	...
	if(image_disable && strlen(image_disable) != 0)
	{
...
BOOL CSS_HandleRadio2(TiXmlElement *pLabel,HXMLRES hXmlRes,HWINDOW hWindow,HELE hEle)
{
	...
	if(image_leave_uncheck && strlen(image_leave_uncheck) != 0)
	{
	...
	if(image_stay_uncheck && strlen(image_stay_uncheck) != 0)
	{
	...
	if(image_down_uncheck && strlen(image_down_uncheck) != 0)
	{
	...
	if(image_disable_uncheck && strlen(image_disable_uncheck) != 0)
	{
	...
	if(image_leave_check && strlen(image_leave_check) != 0)
	{
	...
	if(image_stay_check && strlen(image_stay_check) != 0)
	{
	...
	if(image_down_check && strlen(image_down_check) != 0)
	{
	...
	if(image_disable_check && strlen(image_disable_check) != 0)
	{
...
BOOL CSS_HandlePropertyPageLabel2(TiXmlElement *pLabel,HXMLRES hXmlRes,HWINDOW hWindow,HELE hEle)
{
	...
	const char *labelWidth=pLabel->Attribute(STRA_labelWidth);
	if(labelWidth && strlen( labelWidth ) != 0)
	{
		int w=atoi(labelWidth);
