...
DWORD WINAPI XWnd_SetIcon(HWINDOW hWindow,HICON hIcon, BOOL bBigIcon)
{
	...
	if(bBigIcon)
	{
		return SetClassLong(((window_*)hWindow)->hWnd,GCL_HICON,(LONG)hIcon);
	}else
	{
		return SetClassLong(((window_*)hWindow)->hWnd,GCL_HICONSM,(LONG)hIcon);
	}
}
...
HICON WINAPI XWnd_GetIcon(HWINDOW hWindow,BOOL bBigIcon) //获取窗口图标
{
	...
	if(bBigIcon)
	{
		return (HICON)GetClassLong(((window_*)hWindow)->hWnd,GCL_HICON);
	}else
	{
		return (HICON)GetClassLong(((window_*)hWindow)->hWnd,GCL_HICONSM);
	}
}
...
void Wnd_DrawCaption(HWINDOW hWindow,HDRAW hDraw)
{
	...
	//绘制图标
	HICON hIcon=(HICON)GetClassLong(pWindow->hWnd,GCL_HICONSM);
